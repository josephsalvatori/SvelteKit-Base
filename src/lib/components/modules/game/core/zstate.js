import { CONSTANTS, Action, ActionType } from "./zconstants";
...
class GameState {
    ...
    constructor() {
        ...
        this.playerLocation = CONSTANTS.Location.NULL_LOCATION;
        this.playerPreviousLocation = CONSTANTS.Location.NULL_LOCATION;
        this.playerScore = 0;
