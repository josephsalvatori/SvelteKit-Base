...
import { GameStrings } from "./strings/gamestrings";
import { ObjectStrings } from "./strings/objectstrings";
...
class GameObject {
	...
	constructor(name, loc) {
		...
		this.inventoryID = CONSTANTS.Location.NULL_INVENTORY;
			...
			case "bloody axe":
			{
				...
				switch (this.name)
				{
					...
					case "ZORK owner's manual":
					{
						...
						this.location = CONSTANTS.Location.NULL_LOCATION;
					} break;
					...
					case "brown sack":
					{
						...
						sack.location = CONSTANTS.Location.NULL_LOCATION;
					...
					case "magic boat":
					{
						...
						else
						{
							...
							inflatedBoat.location = CONSTANTS.Location.NULL_LOCATION;
							deflatedBoat.location = CONSTANTS.Location.NULL_LOCATION;
					...
					case "painting":
					{
						...
						painting.location = CONSTANTS.Location.NULL_LOCATION;
	...
	outputInventory() {}
	playerHasObject() { return this.location === CONSTANTS.Location.PLAYER_INVENTORY; }
	randPhrase() {
