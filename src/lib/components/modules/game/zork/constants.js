...
const actions = {
	...
	"restore": {action: ACTION.RESTORE, type: ACTION_TYPE.REFLEXIVE},
	"restore file": {action: ACTION.RESTORE, type: ACTION_TYPE.REFLEXIVE},
	"restore game": {action: ACTION.RESTORE, type: ACTION_TYPE.REFLEXIVE},
	"load": {action: ACTION.RESTORE, type: ACTION_TYPE.REFLEXIVE},
	"load game": {action: ACTION.RESTORE, type: ACTION_TYPE.REFLEXIVE},
	"load file": {action: ACTION.RESTORE, type: ACTION_TYPE.REFLEXIVE},
	"save": {action: ACTION.SAVE, type: ACTION_TYPE.REFLEXIVE},
	"save game": {action: ACTION.SAVE, type: ACTION_TYPE.REFLEXIVE},
